...
\date{Version 1.0 \quad (March 2, 2026)}
...
This note assumes a deterministic signals pack v1.0 (Appendix B) which computes:
...
\section{Integration with RSML governor}
...
\appendix
\section{Appendix A: Minimal claim schema (v1.0)}
...
\section{Appendix B: Deterministic signals pack (v1.0 overview)}
