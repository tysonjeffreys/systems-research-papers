...
\section{Companion note (Fork A)}
Fork A, \texttt{papers/epistemic-load/}, provides the admissibility law for introspective claims and durable
rewrites under epistemic load. Fork B (this note) governs loop stability and revision dynamics. In operational
terms: Fork B decides whether revision should continue; Fork A decides whether a self-claim can update durable state.
